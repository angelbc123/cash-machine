...
{{--                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>--}}
                    <a href="{{ route('transactions.create', ['transaction' => 'cash']) }}" class="btn btn-primary">Go to transaction</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card p-5">
                ...
                <div class="card-body">
                    ...
                    {{--                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>--}}
                    <a href="{{ route('transactions.create', ['transaction' => 'card']) }}" class="btn btn-primary">Go to transaction</a>
                </div>
            </div>
        </div>
        ...
        <div class="col-4">
            <div class="card p-5">
                ...
                <div class="card-body">
                    ...
                    {{--                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>--}}
                    <a href="{{ route('transactions.create', ['transaction' => 'bank']) }}" class="btn btn-primary">Go to transaction</a>
                </div>
            </div>
        </div>
    </div>
